...
export const DOCUMENT_META: Record<DocumentCategory, CategoryMeta> = {
  ...
  Medical: { icon: HeartPulse, bubble: "bg-rose-500/12 text-rose-600 dark:text-rose-400" },
  Insurance: { icon: ShieldCheck, bubble: "bg-emerald-500/12 text-emerald-600 dark:text-emerald-400" },
  Tax: { icon: Landmark, bubble: "bg-amber-500/12 text-amber-600 dark:text-amber-400" },
  Legal: { icon: Gavel, bubble: "bg-red-500/12 text-red-600 dark:text-red-400" },
  Immigration: { icon: Globe, bubble: "bg-sky-500/12 text-sky-600 dark:text-sky-400" },
  Banking: { icon: Banknote, bubble: "bg-emerald-500/12 text-emerald-600 dark:text-emerald-400" },
  Bill: { icon: Receipt, bubble: "bg-sky-500/12 text-sky-600 dark:text-sky-400" },
  Receipt: { icon: Receipt, bubble: "bg-orange-500/12 text-orange-600 dark:text-orange-400" },
  Invoice: { icon: FileText, bubble: "bg-amber-500/12 text-amber-600 dark:text-amber-400" },
  Payslip: { icon: HandCoins, bubble: "bg-emerald-500/12 text-emerald-600 dark:text-emerald-400" },
  ...
  Certificate: { icon: GraduationCap, bubble: "bg-violet-500/12 text-violet-600 dark:text-violet-400" },
  Warranty: { icon: Wrench, bubble: "bg-orange-500/12 text-orange-600 dark:text-orange-400" },
  Manual: { icon: BookOpen, bubble: "bg-slate-500/12 text-slate-600 dark:text-slate-400" },
  Travel: { icon: Plane, bubble: "bg-indigo-500/12 text-indigo-600 dark:text-indigo-400" },
  Event: { icon: Ticket, bubble: "bg-pink-500/12 text-pink-600 dark:text-pink-400" },
  "Business Card": { icon: Briefcase, bubble: "bg-blue-500/12 text-blue-600 dark:text-blue-400" },
  Note: { icon: StickyNote, bubble: "bg-yellow-500/12 text-yellow-600 dark:text-yellow-400" },
  Form: { icon: ScrollText, bubble: "bg-slate-500/12 text-slate-600 dark:text-slate-400" },
  Screenshot: { icon: Smartphone, bubble: "bg-slate-500/12 text-slate-600 dark:text-slate-400" },
