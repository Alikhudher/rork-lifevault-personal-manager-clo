...
const NotFound = () => {
  return (
    <div className="relative flex min-h-dvh flex-col items-center justify-center overflow-hidden bg-gradient-to-b from-[hsl(219,60%,14%)] via-[hsl(218,57%,19%)] to-[hsl(216,52%,26%)] px-8 pt-safe text-center text-white">
      <div className="pointer-events-none absolute -left-24 -top-24 h-64 w-64 rounded-full bg-white/5 blur-2xl" aria-hidden />
      <div className="pointer-events-none absolute -bottom-32 -right-16 h-72 w-72 rounded-full bg-info/20 blur-3xl" aria-hidden />
